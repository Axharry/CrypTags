...
import { Contact, CryptoAddress, DefaultCrypto, CustomCrypto } from '../../../types';
...
export default function EditContactScreen() {
  ...
  const loadData = async () => {
    try {
      // Load contact
      const contact = await contactsStorage.getOne(id!);
      if (contact) {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      <View style={styles.header}>
        ...
        <Text style={[styles.headerTitle, { color: theme.text }]}>Edit Contact</Text>
        <View style={{ width: 44 }} />
      </View>
